...
import jdraw.ldmitry.figuretools.LineTool;
import jdraw.ldmitry.figuretools.OvalTool;
import jdraw.ldmitry.figuretools.RectTool;
import jdraw.std.AbstractContext;
...
public class StdContext extends AbstractContext {
   ...
   */
	...
	protected void doRegisterDrawTools() {
		...
		DrawTool rectangleTool = RectTool.getDrawTool(this);
		addTool(rectangleTool);
		DrawTool lineTool = LineTool.getDrawTool(this);
		addTool(lineTool);
		DrawTool ovalTool = OvalTool.getDrawTool(this);
		addTool(ovalTool);
	}
